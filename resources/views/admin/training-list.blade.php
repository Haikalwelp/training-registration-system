@extends('layouts.app') <!-- Extends the layout from layouts.app -->
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white border rounded shadow p-4">
              ...
              <div class="p-2">
                ...
                @endif
                <div class="p-2"><a href=" {{ route('admin.training-form') }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded">Add New Training</a></div>
                          ...
                          <tbody>
                            ...
                            <tr
                              ...
                              <td class="whitespace-nowrap px-6 py-4">
                                ...
                                <form method="post" action="{{ route('admin.delete-training',$training->id) }}">
                                  <input type="hidden" name="_method" value="DELETE">
                                  @csrf
                                  <a href="{{ route('admin.edit-training-form',$training->id) }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded">Edit</a>
